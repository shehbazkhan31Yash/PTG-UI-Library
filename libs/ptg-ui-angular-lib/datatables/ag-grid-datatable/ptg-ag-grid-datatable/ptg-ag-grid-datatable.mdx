...
import * as PtgAgGridDatatableStories from './ptg-ag-grid-datatable.stories';

<Meta of={PtgAgGridDatatableStories} />
...
<Canvas of={PtgAgGridDatatableStories.ThemeClassName} />
...
<Canvas of={PtgAgGridDatatableStories.Sortable} />
...
<Canvas of={PtgAgGridDatatableStories.Editable} />
...
<Canvas of={PtgAgGridDatatableStories.RowHeight} />
...
<Canvas of={PtgAgGridDatatableStories.RowClass} />
...
<Canvas of={PtgAgGridDatatableStories.RowSelection} />
...
<Canvas of={PtgAgGridDatatableStories.Pagination} />
...
8] paginationLimit -
 ...
 <Canvas of={PtgAgGridDatatableStories.PaginationLimit} />  
...
<Canvas of={PtgAgGridDatatableStories.CustomPaginationClass} />