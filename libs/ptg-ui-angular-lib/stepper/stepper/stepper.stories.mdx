...
import * as StepperComponents from './stepper.stories.ts';

import { StepperComponent } from './stepper.component';

<Meta
  title="Component/StepperComponent/StepperComponentDocs"
...
<Canvas><Story id="component-steppercomponent--primary"/></Canvas> 

c] orientation :  using orientation input user can switch between stepper varients.
<Canvas><Story id="component-steppercomponent--orientation"/></Canvas> 
