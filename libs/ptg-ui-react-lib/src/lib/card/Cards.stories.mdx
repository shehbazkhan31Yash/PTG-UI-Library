...
The `PtgUiCard` component is a versatile card that can display an image, title, description, and an optional button. Below are various examples of how to use this component.
