						...
						<form className="form-login">
							<div className="login-form">
								<div className="form-group mb-4 required">
									<label htmlFor="inputEmail" aria-labelledby="inputEmail" tabIndex={0}>
										{emailLabel}
									</label>
									<div className="userid flex-nowrap">
										<PtgUiInput
											...
											className={`"w-100 form-control bg_0 ${!isEmailValid ? 'border-danger' : ''}`}
											name="email"
								...
								<div className="form-group mb-4 required">
									<label htmlFor="inputPassword" aria-labelledby="inputPassword" tabIndex={0}>
										{passwordLabel}
									</label>
							...
							<PtgUiButton
								className="w-100"
								disabled={user?.email && user?.password && isEmailValid ? false : true}
								data-testid="login"
								width="100%"
